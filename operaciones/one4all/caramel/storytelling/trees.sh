...
awk '{print $0 "\t" $2+$3}' hmm.bed > hmm_sum.bed
awk '{print $0 "\t" $2+$3}' ali.bed > ali_sum.bed
awk '{print $0 "\t" $2+$3}' env.bed > env_sum.bed
...
mv hmm_sum.bed bedrooms/diff
mv ali_sum.bed bedrooms/diff
mv env_sum.bed bedrooms/diff
